...
import { handleCustomerSuccess } from "./_hrh-customer-success.js";
...
// Sales Analytics logic runs — co-located here only because the Vercel
// project's Hobby plan caps deployments at 12 Serverless Functions and was
// already exactly at that cap, not because these reports are related. Every
...
export default async function handler(req, res) {
  ...
  if (req.query.report === "customerSuccess") return handleCustomerSuccess(req, res);
