...
// metric (Participating/Winning/New-Returning/Total Bids/Avg Bids per
// Unique Bidder/Winning via Max Bid) now lives under the Bidder Composition
// section instead (see App.jsx's OverviewTab) so bidder analytics aren't
// scattered across unrelated Overview sections. Today/live bidder activity
...
export default function HeroKPIs({ overview, rangeLabel = "Today", compareLabel, globalCategory = "" }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      {/* AUCTION PERFORMANCE — every auction-level KPI in one panel (no
          separate "Business / Bidder Efficiency" label/date subtitle —
          the active reporting period is already communicated by the
