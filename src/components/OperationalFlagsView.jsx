        ...
        <div className="text-[13.5px] text-ink space-y-3 max-w-3xl">
          ...
          <div className="space-y-2.5">
            {[
              ...
              { rule: "Unpaid/Outstanding Settlement Aging", dept: "Cashier / Finance + Operations", scope: "Period", desc: "Outstanding/Unpaid winning value on auctions that ended >= 3 days ago. HIGH: ended >= 7d and value >= ₱100,000. MEDIUM: ended >= 3d and (value >= ₱50,000 or >= 5 lots)." },
