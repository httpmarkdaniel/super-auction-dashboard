// HRH Online's OWN copy of date-range preset/resolution logic — forked
// from ../utils/dateRange.js (shared with the Auction Dashboard's own
// Topbar/StoreView/App.jsx) specifically so HRH Online can add its own
// extra presets (Previous Week/Month/Year) WITHOUT changing what Auction's
// date picker offers. Same "duplicate small self-contained logic per
// module" convention this dashboard already uses everywhere on the
// backend (every api/_hrh-*.js file has its own resolveRange, never a
// shared import) — this is the same idea on the frontend.
