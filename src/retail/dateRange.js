// Retail's OWN copy of date-range preset/resolution logic — forked from
// ../hrh-online/dateRange.js (itself forked from ../utils/dateRange.js),
// same "duplicate small self-contained logic per module" convention this
// dashboard uses everywhere (every api/_retail-*.js file already has its
// own resolveView/date helpers, never a shared import) — this is the same
// idea on the frontend, and lets Retail's Date Range picker diverge from
// HRH Online's independently later without cross-module coupling.
