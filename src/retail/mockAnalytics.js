...
export const STORE_QUADRANT_DATA = [
  ...
  { store: "Cainta", revenue: 2650000, trafficGrowthPct: -4.2, conversionGrowthPct: -6.0, currentTraffic: 9100, currentConversionPct: 14.0, transactions: 1274 },
  { store: "Marikina", revenue: 2100000, trafficGrowthPct: 6.7, conversionGrowthPct: -3.8, currentTraffic: 8700, currentConversionPct: 12.5, transactions: 1088 },
  { store: "Antipolo", revenue: 1980000, trafficGrowthPct: -2.9, conversionGrowthPct: 4.4, currentTraffic: 7600, currentConversionPct: 16.9, transactions: 1284 },
  { store: "Taytay", revenue: 1750000, trafficGrowthPct: 3.1, conversionGrowthPct: 2.0, currentTraffic: 6900, currentConversionPct: 15.4, transactions: 1063 },
  { store: "San Mateo", revenue: 1420000, trafficGrowthPct: -7.5, conversionGrowthPct: -2.1, currentTraffic: 5200, currentConversionPct: 11.8, transactions: 613 },
  { store: "Angono", revenue: 1180000, trafficGrowthPct: 1.6, conversionGrowthPct: 1.2, currentTraffic: 4700, currentConversionPct: 13.6, transactions: 639 },
  { store: "Binangonan", revenue: 980000, trafficGrowthPct: -1.1, conversionGrowthPct: -4.9, currentTraffic: 4100, currentConversionPct: 10.2, transactions: 418 },
];
...
export const NEEDS_ATTENTION_DATA = [
  { id: 1, priority: "Critical", area: "Store", entity: "San Mateo", issue: "Revenue down 24%", currentMetric: "₱1.1M", benchmark: "₱1.45M previous", businessImpact: "-₱350K", recommendedAction: "Investigate traffic and conversion drop together", status: "Critical" },
  { id: 2, priority: "High", area: "Store", entity: "Cainta", issue: "Revenue down 18%", currentMetric: "₱3.2M", benchmark: "₱3.9M previous", businessImpact: "-₱700K", recommendedAction: "Check traffic and conversion", status: "Investigate" },
  { id: 3, priority: "High", area: "Store", entity: "Marikina", issue: "Conversion down 6pp", currentMetric: "14%", benchmark: "20% previous", businessImpact: "Lost sales opportunity", recommendedAction: "Review traffic quality and store operations", status: "Investigate" },
