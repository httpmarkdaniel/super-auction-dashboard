// Shared Day/Week/Month re-bucketing for Retail's client-side "how do you
// want to look at it" trend controls — same pattern as
// src/hrh-online/trendBucket.js, purely a view of data already fetched for
// the page's selected Date Range filter. Unlike the ClickHouse query logic
// in api/*.js (deliberately duplicated per file so one page's locked
// contract can never be touched by accident), this is pure display
// formatting with no business-metric risk, so sharing it within this
// module is safe.
