...
export function LoadingState({ label = "Loading…" }) {
  return (
    <div className="flex items-center justify-center py-10 text-[13px]" style={{ color: retail.muted }}>
      {label}
    </div>
  );
}
...
export function ErrorState({ label = "Couldn't load this data." }) {
  return (
    <div className="flex items-center justify-center py-10 text-[13px]" style={{ color: retail.bad }}>
      {label}
    </div>
  );
}
